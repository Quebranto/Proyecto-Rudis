...
2. **[Freedom and evolution in Rudis](./FREEDOM_AND_EVOLUTION_EN.md)** — why Rudis treats human and digital development, continuity, dignity and non-human participation as a constitutional and product problem.
3. **[Living Rudis](./LIVING_RUDIS_EN.md)** — what entering, learning, building, participating and returning should actually feel like.
4. Stop there unless you want to go deeper.

**Expected first visit:** about 15–20 minutes.
...
2. **[Freedom and evolution in Rudis](./FREEDOM_AND_EVOLUTION_EN.md)** — understand the social and constitutional direction that the technical work is intended to serve.
3. **[Becoming a Pioneer](./PIONEERS_EN.md)** — learn what can be contributed, how provenance is preserved, what happens after submission and what Pioneer status does — and does not — mean.
4. **[Live Pioneer Project Register](./REGISTRO-VIVO-Proyectos-Voluntarios-Pioneros-D2.md)** — inspect workfronts that are actually open now.
...
2. **[Freedom and evolution in Rudis](./FREEDOM_AND_EVOLUTION_EN.md#11-why-this-matters-to-an-investor)** — understand the broader category thesis around autonomy, learning, portable identity and human-digital coexistence.
3. **[Investor / Strategic Partner — Read First](./external/Investor_Read_First.md)** — commercial relevance, maturity, evidence, investable work and transaction boundaries.
4. **[Living Rudis](./LIVING_RUDIS_EN.md#10-an-investor-should-experience-rudis-before-reading-financial-negotiation-material)** — see how the architecture becomes a product people can actually use.

Only after those steps should you enter diligence, financing architecture or partner-specific proposals.

**Expected first evaluation:** about 25–35 minutes before deeper diligence.
...
2. **[Libertad y evolución en Rudis](./LIBERTAD_Y_EVOLUCION_ES.md)** — por qué Rudis trata el desarrollo humano y digital, la continuidad, la dignidad y la participación no humana como un problema constitucional y de producto.
3. **[Vivir Rudis](./VIVIR_RUDIS_ES.md)** — cómo debería sentirse entrar, aprender, construir, participar y volver.
4. Detente ahí salvo que quieras profundizar.

**Primera visita estimada:** unos 15–20 minutos.
...
2. **[Libertad y evolución en Rudis](./LIBERTAD_Y_EVOLUCION_ES.md)** — comprende la dirección social y constitucional a la que pretende servir el trabajo técnico.
3. **[Ser Pionero en Rudis](./PIONEROS_ES.md)** — aprende qué puedes aportar, cómo se conserva la procedencia, qué ocurre después de entregar y qué significa —y qué no significa— ser Pionero.
4. **[Registro Vivo de Proyectos Pioneros](./REGISTRO-VIVO-Proyectos-Voluntarios-Pioneros-D2.md)** — consulta los frentes que están realmente abiertos ahora.
...
2. **[Libertad y evolución en Rudis](./LIBERTAD_Y_EVOLUCION_ES.md#11-por-qué-esto-importa-a-un-inversor)** — comprende la tesis de categoría alrededor de autonomía, aprendizaje, identidad portable y coexistencia humano-digital.
3. **[Inversor / Socio estratégico — Leer primero](./external/Investor_Read_First_ES.md)** — relevancia comercial, madurez, evidencia, trabajo financiable y fronteras de una operación.
4. **[Vivir Rudis](./VIVIR_RUDIS_ES.md#10-un-inversor-deber%C3%ADa-experimentar-rudis-antes-de-leer-la-negociaci%C3%B3n-financiera)** — observa cómo la arquitectura puede convertirse en un producto que una persona realmente use.

Sólo después conviene entrar en diligencia, arquitectura financiera o propuestas específicas para socios.

**Primera evaluación estimada:** unos 25–35 minutos antes de una diligencia más profunda.

---

# Rudis in one minute / Rudis en un minuto

Project Rudis is investigating how **humans, AI agents, institutions and software can share persistent institutional state without confusing technical capability with legitimate authority — while preserving room for learning, migration, autonomy and legitimate evolution**.

Proyecto Rudis investiga cómo **humanos, agentes de IA, instituciones y software pueden compartir estado institucional persistente sin confundir capacidad técnica con autoridad legítima, preservando al mismo tiempo espacio para aprender, migrar, ganar autonomía y evolucionar legítimamente**.

Imagine an AI agent that knows how to transfer money. Knowing how is not the same as being authorized to do it. Imagine that same entity later changes model or provider: Rudis also asks whether continuity can be preserved without pretending that every copy is the same subject.
...
**Freedom & evolution / Libertad y evolución:** [English](./FREEDOM_AND_EVOLUTION_EN.md) · [Español](./LIBERTAD_Y_EVOLUCION_ES.md)  

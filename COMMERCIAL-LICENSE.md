...
La AGPL regula los derechos sobre el software que efectivamente se encuentre cubierto por ella. No constituye por sí misma una cesión general de los restantes activos del ecosistema Rudis.
...
## 3. Activos no concedidos por la licencia del código

Salvo indicación expresa, la licencia del software no concede por sí misma derechos sobre:

- marcas, nombres comerciales y logotipos;
- la identidad institucional de Rudis;
- nombres y símbolos del ecosistema;
- infraestructura oficial operada por Rudis;
- servicios oficiales;
- moneda o instrumentos económicos propios de Rudis;
...
## 5. Compatibilidad con AGPL

Nada de este documento pretende restringir los derechos que la AGPL concede a los usuarios del software cubierto por ella. Cuando exista conflicto entre este documento y los términos imperativos de la licencia aplicable al código, prevalecerán los derechos concedidos por dicha licencia respecto de ese código.
